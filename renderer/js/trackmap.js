...
export const TRACKS = {
  zolder: {
    ...
    // Default sector boundaries as lap fractions (S1|S2 and S2|S3), from the
    // professional timing sector lengths: S1 ≈ 1.25 km, S2 ≈ 1.50 km,
    // S3 ≈ 1.26 km of 4.011 km. A tracker feed's own timing-loop distances,
    // or a dragged calibration, override these.
    sectorFracs: [0.312, 0.686],
